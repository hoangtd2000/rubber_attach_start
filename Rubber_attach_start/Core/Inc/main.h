...
#define i2_home_y1_GPIO_Port GPIOE
#define i2_home_y1_EXTI_IRQn EXTI15_10_IRQn
#define i3_home_z1_Pin GPIO_PIN_15
#define i3_home_z1_GPIO_Port GPIOE
#define i3_home_z1_EXTI_IRQn EXTI15_10_IRQn
