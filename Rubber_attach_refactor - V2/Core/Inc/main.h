...
#define i6_vacum3_Pin GPIO_PIN_5
#define i6_vacum3_GPIO_Port GPIOC
#define i6_vacum3_EXTI_IRQn EXTI9_5_IRQn
#define i7_vacum4_Pin GPIO_PIN_0
#define i7_vacum4_GPIO_Port GPIOB
#define i8_vacum5_Pin GPIO_PIN_1
...
#define i10_vacum6_Pin GPIO_PIN_8
#define i10_vacum6_GPIO_Port GPIOE
#define i10_vacum6_EXTI_IRQn EXTI9_5_IRQn
